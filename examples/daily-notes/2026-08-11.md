...
activity: gym, golf, guitar, reading  # all | id | id1, id2 (enabled habits); default all
rows: 2  # preferred row count (multi-activity); default 1
columns: 2  # max columns; 1 = vertical stack; default 1
